...
const LoginForm = ({ setIsLogin, setLoading, loading }: any) => {
			...
			getUserEmail(tokenResponse.access_token)
				.then(async (userInfo: any) => {
					...
					const response = await fetch(
						process.env.NEXT_PUBLIC_API_ENDPOINT + '/api/auth/google/login',
						{
							method: 'POST',
							headers: {
	...
	return (
		<div className="min-h-[70vh] w-full flex items-start lg:pt-[10vh] pt-[15vh] justify-center px-4 sm:px-6 lg:px-8 specific-devices-position-login lg:min-h-screen">
